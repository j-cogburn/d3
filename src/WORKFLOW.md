...
| `/ask [anything]` | **Universal entry point.** Natural language interface to all D3 capabilities. Describe what you want; D3 classifies intent, routes to the right command, and executes. |
